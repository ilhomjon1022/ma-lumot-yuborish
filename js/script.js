window.addEventListener("DOMContentLoaded", () => {
  ...
  function postData(form) {
    form.addEventListener("submit", (e) => {
      ...
      statusMessage.textContent = loadingMessage; // Use the defined loading message
      ...
      request.addEventListener("load", () => {
        if (request.status === 200) {
          ...
          statusMessage.textContent = successMessage; // Use the defined success message
        } else {
          console.log("error");
          // Handle the error here, you might want to display an error message.
